    ...
    usemin: {
      ...
      options: {
        assetsDirs: [
          '<%= yeoman.dist %>',
          '<%= yeoman.dist %>/images',
          '<%= yeoman.dist %>/images/cards',
          '<%= yeoman.dist %>/styles'
        ],
        patterns: {
          js: [[/(images\/[^''""]*\.(png|jpg|jpeg|gif|webp|svg))/g, 'Replacing references to images'],
          [/(styles\/[^''""]*\.css)/g, 'Replacing reference to stylesheets']]
        }
      }
    },
    ...
    cssmin: {
      dist: {
        files: [ 
          ...
          { dest: 'dist/styles/about.css', 
            src: ['.tmp/styles/about.css'] },
          { dest: 'dist/styles/main.css', 
            src: ['.tmp/styles/main.css'] },
          { dest: 'dist/styles/work.css', 
            src: ['.tmp/styles/work.css'] } 
        ]
      }
    },
    // uglify: {
